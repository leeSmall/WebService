 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://impl.ws.webservice.study.com/", wsdlLocation = "http://192.168.152.1:8989/WS_Server/Webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://impl.ws.webservice.study.com/", "WebServiceImplService");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://impl.ws.webservice.study.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.ws.webservice.study.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
